    ...
    <script>
        ...
        function initLazyLoader() {
            ...
            if (goodsContainer) {
                ...
                // 设置懒加载容器和类型
                window.lazyLoader.setup(goodsContainer, 'new', {});
        ...
        function getLazyLoadConfig() {
            return {
                ...
                loadingHtml: '<div class="loading-state"><div class="loading-spinner"></div><p>正在加载新品...</p></div>',
                emptyHtml: '<div class="empty-state"><div class="empty-state-icon">✨</div><h3 class="empty-state-title">暂无新品</h3><p class="empty-state-description">目前没有新品上架，请查看热销商品</p><div class="empty-state-actions"><a href="goods?action=hot" class="btn-view-detail">查看热销</a></div></div>',
                errorHtml: '<div class="empty-state"><div class="empty-state-icon">⚠️</div><h3 class="empty-state-title">加载失败</h3><p class="empty-state-description">加载新品失败，请重试</p><div class="empty-state-actions"><button onclick="location.reload()" class="btn-add-cart">重新加载</button></div></div>',
                goodsCardTemplate: function(goods) {
                    ...
                    cardHtml += '<div class="product-category new-badge">新品推荐</div>';
                    if (isOutOfStock) {
...
<body class="recommend-page new-page">
    <!-- 顶部导航栏 -->
    <header class="header">
        <div class="nav-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="goods?action=new" class="active">新品</a></li>
                    <%
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-icon new-icon">✨</div>
            <div class="page-title-section">
                <h1 class="page-title">${pageTitle}</h1>
                <p class="page-subtitle">最新上市的精美蛋糕，新鲜出炉，等您品尝</p>
            </div>
        </div>
